  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto bg-slate-100 overflow-visible">
      ...
      <div className="relative z-20 min-h-[420px] md:min-h-[520px]">
        <div className="absolute left-[25%] top-[58%] bg-white shadow-md rounded-md px-3 py-1 text-sm z-[9999]">
          <span>🇲🇽</span> SA
        </div>
        ...
        <div className="absolute right-[20%] top-[35%] bg-white shadow-md rounded-md px-3 py-1 text-sm z-[9999]">
          <span>🇫🇮</span> Europe
        </div>

        <div className="absolute right-[20%] bottom-[45%] bg-white shadow-md rounded-md px-3 py-1 text-sm z-[9999]">
          <span>🇮🇳</span> India
        </div>
      </div>
    </div>
