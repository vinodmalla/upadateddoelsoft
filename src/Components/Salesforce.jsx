  ...
  return (
    <div className="w-full font-kumbh bg-white xl:mt-10 overflow-x-hidden">
      ...
      <section className="mx-auto px-6 sm:px-12 md:px-24 py-16 bg-[#F4F6FB] grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex justify-center md:-mb-40">
          <img
            ...
            alt="Salesforce Team"
             className="w-auto h-auto md:w-[620px] md:h-[620px] p-4"
          />
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 sm:px-10 lg:px-20 py-12 grid gap-10 md:grid-cols-2 items-center">
        {/* Left Image */}
        <div className="flex justify-center md:ml-8 md:justify-start">
          <img
      ...
      <section className="bg-[#F4F6FB] py-10">
        <div className="px-6 sm:px-12 md:px-20 md:ml-7 text-center md:text-left space-y-4">
          <h1  className="text-3xl sm:text-4xl font-bold"> 🏢 Industries We Empower with Salesforce</h1>
          <p className="text-gray-600 md:ml-2"> Doelsoft enables businesses across industries to unlock Salesforce
            potential:</p>
        </div>
      ...
      <section className="bg-white py-12">
        <div className="md:ml-8 px-6 sm:px-10 md:px-20 mb-10">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-kumbh font-semibold mb-4 leading-[66px]">
            👨‍💻 Doelsoft Salesforce Talent Pool
          </h1>
          <p className="text-lg justify-start sm:text-xl md:ml-2 text-black font-inter font-normal leading-8">
            Our Salesforce-certified experts ensure maximum ROI:
          </p>
        </div>

        <div className="container mx-auto px-6 sm:px-10 md:px-20 md:ml-8 max-w-7xl grid gap-8 sm:grid-cols-2">
          {[
            {
              src: '/s1.svg',
      ...
      {/* Why Choose Section */}
      <section className="bg-[#F4F6FA] py-12 px-6 sm:px-10 lg:px-20 font-sans" style={{marginBottom:"-44px"}}>
        <div className="max-w-7xl mx-auto flex flex-col-reverse xl:flex-row items-center gap-10">
          <div className="flex-1 space-y-6 ">
            <h1 className="text-2xl md:text-3xl ml-auto xl:ml-[-29px] xl:text-4xl  justify-start md:whitespace-nowrap font-kumbh font-semibold mb-8 leading-[57.20px]">
          ...
          <div className="flex-1 flex justify-center">
            <img
              ...
              className="w-full h-auto xl:w-[619px] xl:h-[818px]  "
            />
          </div>
        </div>
      </section>
      ...
      <section className="relative w-full bg-cover bg-center text-center py-16 md:h-[568px] sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden" style={{ backgroundImage: "url('/Background2.svg')",marginTop:"1px" } } > {/* Decorative Vectors */}
        ...
        <img src="/right.svg" alt="right" className="absolute right-10 sm:right-40 lg:right-72 top-6 sm:top-12 w-10 sm:w-16 md:w-20 object-contain opacity-70 z-30" /> {/* Dark overlay */}
         ...
         <div className="relative max-w-3xl mx-auto md:mt-8 text-white z-10 flex flex-col items-center justify-center space-y-5 sm:space-y-7 md:space-y-8"> 
           <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-[56px] font-manrope font-bold whitespace-nowrap leading-snug px-2">🌍 Unlock Salesforce Power with Doelsoft </h2>
            <p className="text-lg lg:text-[28px] xl:text-[30px] font-inter text-gray-200 leading-relaxed px-2"> 👉 Partner with Doelsoft – Your Salesforce consulting and development company in the USA & India. </p>
